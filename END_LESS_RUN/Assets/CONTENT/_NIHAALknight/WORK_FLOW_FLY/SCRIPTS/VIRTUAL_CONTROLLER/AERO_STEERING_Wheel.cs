...
public class AERO_STEERING_Wheel : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    {    //to get the position of the corners of the image in the world
        ...
        centerpoint = new Vector2(AWheelAngle, 0f);
    ...
    public float ROT_Horizontal()
    {
        ...
        if (centerpoint.x != 0)
            ...
            return Input.GetAxis("ROT_Horizontal");

    }

   // public float StandROT_Horizontal()
   // {
        //Debug.Log(wheelAngle);
        //Debug.Log(centerPoint);
   //     if (centerpoint.x != 0)
   ...
   //     else
    ...
    //        return Input.GetAxis("StandROT_Horizontal");
